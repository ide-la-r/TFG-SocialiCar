                    ...
                    <div class="card-container">
                        <div class="card text-center first-card">
                            <div class="card-body">
                                ...
                                <a href="" class="btn btn-outline-primary mt-3 boton2" style="color: white; background-color: rgba(17, 112, 255, 0.99)">Suscribirse</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-container">
                        <div class="card text-center second-card">
                            <div class="card-body">
                                ...
                                <a href="" class="btn btn-outline-warning boton1" style="background-color:rgba(242, 255, 0, 0.18); color: white">Suscribirse</a>
                            </div>
                        </div>
                    </div>
                </div>
