...
<head>
    ...
    <title>403 - Área restringida</title>
...
<body>
    <svg xmlns="http://www.w3.org/2000/svg" id="robot-error" viewBox="0 0 260 118.9" role="img">
        <title xml:lang="en">403 Error</title>
                ...
                <path class="alarm" fill="#C4EEF2" d="M120.9 19.6V9.1c0-5 4.1-9.1 9.1-9.1h0c5 0 9.1 4.1 9.1 9.1v10.6" />
    ...
    <h2>¡Vuelve al <a href="/">Inicio</a>!</h2>
